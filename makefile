all:
	...
	i686-elf-gcc -T ./link/linker.ld -o ./compiled/ddmOS.bin -ffreestanding -O2 -nostdlib ./usr/bf.h ./include/kernel/fonts.h ./include/kernel/vga.h ./include/ddcLib/ddcString.h ./include/kernel/serial.h ./include/kernel/ddsh.h ./include/kernel/interrupt.h ./include/ddcLib/make.h ./include/kernel/system.h ./include/kernel/kernel.h ./include/kernel/tty.h ./include/kernel/keyboard.h ./compiled/vga.o ./compiled/ddcString.o ./compiled/fonts.o ./compiled/serial.o ./compiled/ddsh.o ./compiled/interrupt.o ./compiled/sinterrupt.o ./compiled/boot.o ./compiled/make.o ./compiled/system.o ./compiled/keyboard.o ./compiled/tty.o ./compiled/kernel.o -lgcc
