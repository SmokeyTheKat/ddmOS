all:
	...
	i686-elf-gcc -T ./link/linker.ld -o ./compiled/ddmOS.bin -ffreestanding -O2 -nostdlib ./include/kernel/interrupt.h ./include/kernel/gdt.h ./include/ddcLib/make.h ./include/kernel/system.h ./include/kernel/kernel.h ./include/kernel/tty.h ./include/kernel/keyboard.h ./compiled/interrupt.o ./compiled/sinterrupt.o ./compiled/boot.o ./compiled/gdt.o ./compiled/sgdt.o ./compiled/make.o ./compiled/system.o ./compiled/keyboard.o ./compiled/tty.o ./compiled/kernel.o -lgcc
