all:
	...
	i686-elf-gcc -T ./link/linker.ld -o ./compiled/ddmOS.bin -ffreestanding -O2 -nostdlib ./include/kernel/system.h ./include/kernel/kernel.h ./include/kernel/tty.h ./include/kernel/keyboard.h ./compiled/system.o ./compiled/keyboard.o ./compiled/tty.o ./compiled/kernel.o ./compiled/boot.o -lgcc
run:
